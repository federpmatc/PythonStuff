...
#system('libcamera-hello -t 3000') #preview image 3000ms
#system('libcamera-jpeg -o test.jpg') #take a pic
##system('libcamera-jpeg -o test.jpg -t 2000 --width 640 --height 480') #take a pic 2 sec preview, 640x480
#libcamera-still allows files to be saved in a number of different formats.
#libcamera-still -e png -o test.png
#system('libcamera-still -e bmp -o ~/test2.bmp')
